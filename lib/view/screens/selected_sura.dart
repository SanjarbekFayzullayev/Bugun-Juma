...
class SelectSurah extends StatefulWidget {
  const SelectSurah({Key? key}) : super(key: key);

  @override
  _SelectSurahState createState() => _SelectSurahState();
}
                        ...
                        return Container(
                          ...
                          child: SafeArea(
                            child: indexCubit.isEmpty
                                ...
                                : ListView.builder(
                                    itemCount: indexCubit.length,
                                    itemBuilder: (context, index) {
                                      final data = snapshot.data!
                                          .data![int.parse(indexCubit[index])];
                                      return Card(
